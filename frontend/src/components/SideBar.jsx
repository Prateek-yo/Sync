...
const SideBar = ({ selectedUser, setSelectedUser }) => {
    ...
    return (
        <div 
    className={`w-[300px] md:w-[330px] max-md:w-full bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white 
                    ...
                    userDummyData.map((user, index) => (
                        ...
                        >
                            ...
                            <div className='flex flex-col leading-5'>
                                ...
                                <p className="truncate w-[150px]">{user.fullName}</p>
